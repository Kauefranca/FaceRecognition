...
void detectAndDisplay(Mat frame)
{
...

	{
		...
		stringstream ssfn;
		filename = "C:\\Users\\Usuario\\Desktop\\Faces\\";
...
void addFace()
{
	...
	if (!face_cascade.load("C:\\Users\\Usuario\\Downloads\\haarcascade_frontalface_default.xml"))
	{
		cout << "error" << endl;
		return;
	};
...
void eigenFaceTrainer() {
	...
	model->save("C:\\Users\\Usuario\\Downloads\\eigenfaces.yml");
...
void  FaceRecognition() {
	...
	model->read("C:\\Users\\Usuario\\Downloads\\eigenfaces.yml");

	Mat testSample = imread("C:\\Users\\Usuario\\Desktop\\0.jpg", 0);
